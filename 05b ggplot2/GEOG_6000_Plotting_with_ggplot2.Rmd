...
## Introduction
The base installation of R contains several functions for plotting and visualizing data. In addition to these, there are several addon packages that greatly extend the basic functionality. Here, we will look at one the most widely used of these, **ggplot2**.
