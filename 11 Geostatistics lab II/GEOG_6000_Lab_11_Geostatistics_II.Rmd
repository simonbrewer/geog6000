...
You will need the **gstat** package to perform the variogram analysis and spatial prediction, and the **rgdal** and **sp** packages to load data. You will need to download the following files and unzip them in your working directory: 
