---
title: "GEOG 6000 Lab 13 Geostatistics II"
author: "Simon Brewer"
...
Before starting the lab, you will need to set up a new folder for your working directory. Go to your `geog6000` folder now and create a new folder for today's class called `lab13`. The following files will be used in this lab, all available on Canvas:  
...
Now start RStudio and change the working directory to `lab13`. As a reminder, you can do this by going to the [Session] menu in RStudio, then [Change working directory]. This will open a file browser that you can use to browse through your computer and find the folder. 
