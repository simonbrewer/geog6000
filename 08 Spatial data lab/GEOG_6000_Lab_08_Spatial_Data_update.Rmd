...
__The uber-rule for working with any spatial data is to make sure all of it is in the same CRS.__ Never ever ever ever do anything with your data until you are sure you've got the CRS right.
...
Note: this should only be used when the simple feature is missing a CRS and you know what it is. It is __NOT__ for _changing_ the CRS.
