...
R Command & Purpose \\
\hline
\textbf{Convert object types} & \\
\hline
\texttt{barplot} & Barplot using vector of heights \\
\texttt{dotplot} & Simple index plot \\
\texttt{abline} & Add reference line to figure \\
\texttt{points} & Add points to figure \\
\texttt{lines} & Add lines to figure \\
\texttt{polygon} & Add filled polygon to figure \\
\texttt{image} & Heatmap of matrix \\
\texttt{contour} & Contour plot of matrix \\
\texttt{persp} & 3D wireframe plot \\
\hline
