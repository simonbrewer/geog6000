...
```{r eval=FALSE}
plot(kid.score ~ mom.iq2, data = kidiq, 
     col = (kidiq$mom.hs+1), pch = 16)
```
...
Save your script as *myvif.R*. Now we can then start to analyze `x` in the function. Add the following lines between the curly brackets:
