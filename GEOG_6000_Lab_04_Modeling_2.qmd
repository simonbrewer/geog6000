...
In this lab, we will look at how to build basic models in R, how to extend them to include some simple terms and how to perform some simple diagnostics. 
...
runoff <- read.csv("./data/SoCal_Runoff.csv")
