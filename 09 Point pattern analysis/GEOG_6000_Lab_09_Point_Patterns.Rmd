---
title: "GEOG 6000 Lab 08 Spatial point patterns"
author: "Simon Brewer"
...
In this lab, we will carry out some point pattern data analysis. 
...
You will need three packages to carry out all the steps listed here: **rgdal**, **maptools** and **spatstat**, so make sure these are installed these before starting. The following files will be used:
