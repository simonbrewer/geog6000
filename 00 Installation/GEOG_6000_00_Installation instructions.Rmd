...
To install R on a Mac, click the “Download R for Mac” link, then download the package link (`R-4.0.0.pkg`). Once this has downloaded, click on the file to run the installer. There are some options during the installation, but I'd recommend using the defaults for these. If your computer requires a password before installing new programs, you’ll need it here.
