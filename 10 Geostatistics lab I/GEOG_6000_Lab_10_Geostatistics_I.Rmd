...
And finally, we'll plot the adata and country outline using **ggplot2**
...
```{r fig.keep='none'}
plot(ppt.pred.ok["var1.var"], main = "Interpolated precipitation prediction error (OK)")
```
...
```{r fig.keep='none'}
bubble(as_Spatial(ppt.cv.ok)[,"residual"], pch = 16)
```
